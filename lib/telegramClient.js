...
app.listen(port, () => {
    console.log(`[INFO] Server running on http://ec2-3-80-88-97.compute-1.amazonaws.com:${port}`);
});
...
async function fetchBundleData(parsedJSON) {
    ...
    try {
        ...
        await new Promise(resolve => setTimeout(resolve, 9000)); // Wait an additional 5 seconds
